...
export class AntigravityAdapter extends ProviderAdapter {
  constructor() { super('antigravity'); this.workspaceDir = process.env.WORKSPACE_DIR || '/home/dev'; this.defaultTimeoutMs = parseInt(process.env.ANTIGRAVITY_TIMEOUT_MS || '120000', 10); this.modelDiscoveryTimeoutMs = parseInt(process.env.ANTIGRAVITY_MODEL_DISCOVERY_TIMEOUT_MS || '60000', 10); this.cachedModels = null; this.lastModelCheck = 0; }
