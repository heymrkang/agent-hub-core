...
- `PHASE_20_DEPLOY_VOICE_QUOTA.md`: `PLANNED` — Coolify Deploy Integration & Voice Prompting (STT)
- `PHASE_21_V2_LTS_HARDENING.md`: `PLANNED` — V2 LTS Final Hardening & Optimization (Feature Freeze)
